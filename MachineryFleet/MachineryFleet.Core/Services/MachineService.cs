...
namespace MachineryFleet.Core.Services
{
    public class MachineService : IMachineService
    {
        ...
        // Generate code to add a log entry to a machine with a given id asynchronously formatting the log entry as a string and adding it to the machine's log entries collection. the log entry should contain a timestamp/datetimestamp and the log entry string. If the machine with the given id does not exist, throw an InvalidOperationException with the message "Machine with id {id} not found". If the log entry cannot be added to the machine , throw an InvalidOperationException with the message "Failed to add log entry to machine with id {id}".
